...
public class EnemySpear : ADamageable
{
    public override void OnHit()
    {
        ...
        GiveDamage(damage);
        PlayerMove.Instance.KnockBack(((Vector2)PlayerInfo.Instance.gameObject.transform.position - contactPoint).normalized, 18f, 0.1f);
